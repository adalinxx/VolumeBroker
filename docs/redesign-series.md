...
This PR is stacked on the cashew atomic-Volume lifecycle branch. The temporary branch requirement in `Package.swift` exists so CI validates both sides of the traversal/storage contract together.
